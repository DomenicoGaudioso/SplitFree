...
import { AvatarStack, Button, Card, EmptyState, Fab, Screen, SectionHeader, Tag } from "@/ui/components";
      ...
      <View style={styles.row}>
        ...
        <View style={{ flex: 1, marginLeft: spacing.md }}>
          ...
          <Text style={{ color: t.textMuted, fontSize: font.small, marginTop: 2 }}>
            {count} {count === 1 ? "spesa" : "spese"} · totale {formatMinor(total, group.currency)}
          </Text>
